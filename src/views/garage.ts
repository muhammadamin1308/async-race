  ...
  <div class="top-panel">
    <div class="form-row">
      <form id="create-form" class="form-inline">
        ...
        <input class="color-input" type="color" id="create-color" value="#000000" />
      ...
      <form id="update-form" class="form-inline">
        ...
        <input class="color-input" type="color" id="update-color" value="#000000" />
    ...
    carItem.innerHTML = `
      ...
      <div class="finish-line">
        <svg class="svg" version="1.0" xmlns="http://www.w3.org/2000/svg"
          width="5em" height="3em" viewBox="0 0 1280.000000 640.000000"
